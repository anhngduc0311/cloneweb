    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Follows", x => new { x.UserId, x.MangaId });
                    table.ForeignKey(
                        name: "FK_Follows_Mangas_MangaId",
                        column: x => x.MangaId,
                        principalTable: "Mangas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Histories", x => new { x.UserId, x.MangaId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Histories_Mangas_MangaId",
                        column: x => x.MangaId,
                        principalTable: "Mangas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chapters_MangaId_Number_Language",
                table: "Chapters",
                columns: new[] { "MangaId", "Number", "Language" });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_MangaId_CreatedAt",
                table: "Comments",
                columns: new[] { "MangaId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_MangaId",
                table: "Histories",
                column: "MangaId");

            migrationBuilder.CreateIndex(
                name: "IX_Mangas_UpdatedAt",
                table: "Mangas",
                column: "UpdatedAt");
